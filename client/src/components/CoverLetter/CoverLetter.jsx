...
const CoverLetter = () => {
  ...
  const [currentCoverLetter, setCurrentCoverLetter] = useState(
    `Hi there, thanks for taking the time to review my application! My name is Som–I’m a Junior front-end developer, and I primarily code in Javascript. I am excited to be applying for ${currentData.jobName} at ${currentData.company}. 
